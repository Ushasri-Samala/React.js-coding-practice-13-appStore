...
class AppStore extends Component {
  ...
  render() {
    ...
    let projectDetails = this.getFilteredProjects()
    projectDetails = projectDetails.filter(eachProject =>
      eachProject.appName.toLowerCase().includes(searchInput.toLowerCase()),
    )
